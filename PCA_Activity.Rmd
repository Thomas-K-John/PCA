...
rm(list = ls(all=TRUE))
setwd("I:/DATA-SCIENCE/Insofe/DocumentsAfterModuleCompleted/Module-2-7302-DecisionModelling/July-9th-PCA-NaiveBayes-Regularisation-H2O/20170709_Batch30_CSE7302c_PCA_Activity")
```
...
plot(pca_df$V1, pca_df$V2, col = pca_df$Species, xlab = "Principal Component 1", ylab = "Principal Component 2",
...
pca_auto <- prcomp(iris_data[,-c(5)])

plot(pca_auto)

iris_pca_data = data.frame(pca_auto$x, Species = iris_data$Species)

plot(iris_pca_data$PC1, iris_pca_data$PC2, col = iris_pca_data$Species, xlab = "Principal Component 1", ylab = "Principal Component 2",  main = "Linear Separability after PCA")
...
pca_scale <- prcomp(iris_data[,-c(5)], center = T, scale. = T)

plot(pca_scale)

iris_pca_Scale_data = data.frame(pca_scale$x, Species = iris_data$Species)

plot(iris_pca_Scale_data$PC1, iris_pca_Scale_data$PC2, col = iris_pca_Scale_data$Species, xlab = "Principal Component 1", ylab = "Principal Component 2",  main = "Linear Separability after PCA")
